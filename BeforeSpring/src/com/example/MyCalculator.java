...
public class MyCalculator {
	...
	/*
	 * public void setFirstNum(int firstNum) { this.firstNum = firstNum; } public
	 * void setSecondNum(int secondNum) { this.secondNum = secondNum; } public void
	 * setCalculator(Calculator calculator){ this.calculator = calculator; }
	 */
	public void add(){
